...
<head>
    ...
    <script src="<?php bloginfo('stylesheet_directory'); ?>/masonry.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory'); ?>/quantize.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory'); ?>/color-thief.js" type="text/javascript"></script>
